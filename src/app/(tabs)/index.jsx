...
export default function TournamentsScreen() {
  ...
  const { data, isLoading, error, refetch } = useQuery({
    ...
    retry: 3,
    retryDelay: (attempt) => Math.min(500 * Math.pow(2, attempt), 8000),
  });
  ...
  const TournamentCard = ({ tournament, showOwnerBadge = false }) => {
    ...
    const typeColor = isLeague ? "#22c55e" : "#f97316"; // green : orange
    const typeFaintColor = isLeague
      ? "rgba(34,197,94,0.2)"
      : "rgba(249,115,22,0.2)";
    const typeBorderColor = isLeague
      ? "rgba(34,197,94,0.35)"
      : "rgba(249,115,22,0.35)";
    const typeTextColor = isLeague ? "#86efac" : "#fdba74";
    ...
    return (
      ...
      >
          ...
          >
            ...
            <View
              style={{
                ...
                paddingHorizontal: 7,
                paddingVertical: 3,
                backgroundColor: typeFaintColor,
                borderRadius: 6,
                borderWidth: 1,
            ...
            >
              {isLeague ? (
                <Layers size={11} color={typeTextColor} />
              ) : (
                <Trophy size={11} color={typeTextColor} />
              )}
              <Text
                style={{
                  fontSize: 10,
            ...
            {showOwnerBadge && (
              ...
              >
                ...
                >
                  {isLeague ? "MY LEAGUE" : "MY TOURNAMENT"}
                </Text>
              </View>
            )}
          </View>
        ...
        >
          ...
          >
            {isLeague ? (
              <Layers size={14} color={typeTextColor} />
            ) : (
              <Trophy size={14} color={typeTextColor} />
            )}
            <Text
              style={{ fontSize: 12, fontWeight: "600", color: typeTextColor }}
            >
              {isLeague ? "View League" : "View Tournament"}
            </Text>
          </View>
