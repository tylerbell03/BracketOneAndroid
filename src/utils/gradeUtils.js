export function getGradeLabel(grade) {
  ...
  if (grade === "15" || grade === 15) return "Middle School";
  if (grade === "0" || grade === 0) return "JV";
  if (grade === "14" || grade === 14) return "Varsity";
  if (grade === "16" || grade === 16) return "High School";
  if (grade === "17" || grade === 17) return "Men's";
  if (grade === "18" || grade === 18) return "Women's";
...
function getGradeSortValue(grade) {
  ...
  // Men's (17) comes after High School
  if (gradeNum === 17) return 12.5;

  // Women's (18) comes after Men's
  if (gradeNum === 18) return 12.6;
